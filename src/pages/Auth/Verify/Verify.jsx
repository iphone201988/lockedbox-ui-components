             ...
             <div className="max-w-[1440px] w-full px-[40px] py-[40px] mx-auto flex  gap-10 max-lg:px-[20px] max-md:flex-col">
               ...
               <div className="w-full relative h-full flex items-center justify-center flex-col">
                 <img
                   ...
                   alt=""
                 />
                 <h1 className="text-[52px] font-bold max-lg:text-[36px] text-center">Verify your account</h1>
                 <p className='text-center mt-[16px]'>Enter the code you  received via SMS or email</p>
                 <div className="w-full mt-[30px] flex flex-col gap-[20px] items-center">
                   <div className="input-with-icon relative w-full max-w-[540px] flex items-center justify-center gap-[20px]">
                     <input
                 ...
                 <button className="btn-pri mt-[40px] cursor-pointer">Verify</button>
                 <p className="mt-[40px]">Resend code in  <a className="text-[#235370] font-semibold" href="">60s</a></p>
               </div>
             </div>
           </div>
  )

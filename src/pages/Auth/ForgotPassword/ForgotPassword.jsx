         ...
         <div className="max-w-[1440px] w-full px-[40px] py-[40px] mx-auto flex  gap-10 max-lg:px-[20px] max-md:flex-col">
           ...
           <div className="w-full relative h-full flex items-center justify-center flex-col">
             <img
               ...
               alt=""
             />
             <h1 className="text-[52px] font-bold max-lg:text-[36px] text-center">Forgot Password</h1>
             <p className='text-center mt-[16px]'>Enter Email/Phone number to get OTP</p>
             ...
             <div className="w-full max-w-[540px]">
              <div className="select-option flex justify-end mb-[10px] gap-[12px]">
                <button className="btn-pri">Use Email</button>
                <button className="btn-sec">Use Phone number</button>
              </div>
              {/* for email */}

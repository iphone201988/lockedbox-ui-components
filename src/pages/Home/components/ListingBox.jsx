...
<p className='text-[14px] mt-[-6px]'>(7 reviews)</p>
      </div>
      <a className='mt-[10px] text-[24px] font-semibold text-[#235370] block w-[140px] leading-[normal]' href="#">Office space for storage</a>
      <p className='flex text-[#959595] gap-[6px] mt-[4px]'>

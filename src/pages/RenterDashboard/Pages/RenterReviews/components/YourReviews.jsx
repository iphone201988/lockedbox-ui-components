  ...
  return (
    <div className='p-[10px] border border-[#EEEEEE] rounded-[16px] max-w-[260px]'>
      <div className="flex items-center gap-[8px]">
        ...
        <p className='text-[14px] mt-[8px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy</p>
    </div>
  )
}
